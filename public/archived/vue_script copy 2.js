...
const app2 = new Vue({
  ...
  data: {
    ...
    gender: "",
    personalInfos: [this.personalInfo1, this.personalInfo2, this.personalInfo3, this.personalInfo6, this.gender]
  }
})
...
const vam = new Vue({
  ...
  data: {
    ...
    localOrder: {
      details: { x: 0, y: 0 },
      target: "T",
      personalInfos: app2.personalInfos
    },
  },
  /*created: function () {
   ...
   * a client), the server responds withvam a currentQueue message (this is
  ...
  methods: {
    ...
    addOrder: function (event) {
      ...
      socket.emit('addOrder', {
        ...
        personalInfos: vam.personalInfos
        //    orderItems: ['Beans', 'Curry'],
      });
    }
  }
